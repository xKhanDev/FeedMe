        ...
        <div>
          ...
          <ul>
            <li className="mb-2 text-sm">
              DonorVerse is a secure fundraising DApp where users can create
              campaigns, donate to those in need, chat with creators, and earn
      ...
      <div className="border-t border-gray-700 mt-10 pt-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mb-4 md:mb-0">
            ...
            <a href="www.linkedin.com/in/safeer-khan-x" target="_blank">
              LinkedIn
            </a>
          </div>
        </div>
